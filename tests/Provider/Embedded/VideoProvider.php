...
/**
 * Data provider for {@see \UIAwesome\Html\Tests\Embedded\VideoTest} test cases.
 */
final class VideoProvider
{
     ...
     *
     * @return array<string, array{Closure(): Video, string, string, string}>
     */
    public static function invalidAttributeValues(): array
    {
        return [
            'controlslist' => [
                static fn(): Video => Video::tag()->controlslist('invalid-value'),
                'invalid-value',
                'controlslist',
                self::validControlslistValues(),
            ],
            'controlslist with empty token before invalid token' => [
                static fn(): Video => Video::tag()->controlslist("nodownload\t\ninvalid-value"),
                'invalid-value',
                'controlslist',
                self::validControlslistValues(),
            ],
            'controlslist with invalid token list' => [
                static fn(): Video => Video::tag()->controlslist('nodownload invalid-value'),
                'invalid-value',
                'controlslist',
                self::validControlslistValues(),
            ],
            ...
            'crossorigin' => [
                static fn(): Video => Video::tag()->crossorigin('invalid-value'),
                'invalid-value',
                Attribute::CROSSORIGIN->value,
                implode("', '", Enum::normalizeStringArray(Crossorigin::cases())),
            ],
            'preload' => [
                static fn(): Video => Video::tag()->preload('invalid-value'),
                'invalid-value',
                'preload',
