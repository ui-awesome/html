...
final class HrTest extends TestCase
{
    ...
    public function testRenderWithContentEditable(): void
    {
        self::assertSame(
            ...
            HTML,
            Hr::tag()->contentEditable(true)->render(),
    ...
    public function testRenderWithContentEditableUsingEnum(): void
    {
        self::assertSame(
            ...
            <hr contenteditable="true">
            HTML,
            Hr::tag()->contentEditable(ContentEditable::TRUE)->render(),
    ...
    public function testRenderWithDraggableUsingEnum(): void
    {
        self::assertSame(
            ...
            <hr draggable="true">
            HTML,
            Hr::tag()->draggable(Draggable::TRUE)->render(),
    ...
    public function testRenderWithMicroData(): void
    {
        self::assertSame(
            <<<HTML
            <hr itemid="https://example.com/item" itemprop="name" itemref="info" itemscope itemtype="https://schema.org/Thing">
            HTML,
            Hr::tag()
