...
final class PreTest extends TestCase
{
    ...
    public function testGetAttributeReturnsDefaultWhenMissing(): void
    {
        self::assertSame(
            'value',
            Pre::tag()->getAttribute('class', 'value'),
    ...
    public function testRenderWithAriaAttributes(): void
    {
        self::assertSame(
            <<<HTML
            <pre aria-controls="value" aria-label="value">
            </pre>
            HTML,
            Pre::tag()
                ->ariaAttributes(
    ...
    public function testRenderWithEvents(): void
    {
        self::assertSame(
            <<<HTML
            <pre onfocus="handleFocus()" onblur="handleBlur()">
            </pre>
            HTML,
            Pre::tag()
                ->events(
    ...
    public function testRenderWithMicroData(): void
    {
        self::assertSame(
            <<<HTML
            <pre itemid="https://example.com/item" itemprop="name" itemref="info" itemscope itemtype="https://schema.org/Thing">
            </pre>
            HTML,
            Pre::tag()
    ...
    public function testRenderWithUserOverridesGlobalDefaults(): void
    {
        ...
        self::assertSame(
            <<<HTML
            <pre class="from-global" id="value">
            </pre>
            HTML,
            Pre::tag(['id' => 'value'])->render(),
    ...
    public function testThrowInvalidArgumentExceptionWhenSettingContentEditable(): void
    {
        ...
        Pre::tag()->contentEditable('invalid-value');
    }
    ...
    public function testThrowInvalidArgumentExceptionWhenSettingDraggable(): void
    {
        ...
        Pre::tag()->draggable('invalid-value');
    }
    ...
    public function testThrowInvalidArgumentExceptionWhenSettingTranslate(): void
    {
        ...
        Pre::tag()->translate('invalid-value');
    }
}
