...
/**
 * Unit tests for {@see Aside} `<aside>` behavior.
 *
 * Verifies rendered output, attribute handling, configuration precedence, and content encoding for {@see Aside::tag()}.
 *
 * Test coverage.
 ...
 *
 * {@see Aside} for implementation details.
 *
