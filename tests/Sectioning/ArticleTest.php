...
final class ArticleTest extends TestCase
{
    ...
    public function testGetAttributeReturnsDefaultWhenMissing(): void
    {
        self::assertSame(
            'default',
            Article::tag()->getAttribute('data-test', 'default'),
    ...
    {
        SimpleFactory::setDefaults(Article::class, ['class' => 'default-class']);
        ...
        SimpleFactory::setDefaults(Article::class, []);
    }
    ...
    {
        SimpleFactory::setDefaults(Article::class, ['class' => 'from-global', 'id' => 'id-global']);
