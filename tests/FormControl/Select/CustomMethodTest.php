...
final class CustomMethodTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPrefixClass(): void
    {
        Assert::equalsWithoutLE(
            ...
            HTML,
            Select::widget()->items($this->cities)->prefix('value')->prefixClass('value')->prefixTag()->render()
        );
    }
    ...
    public function testSuffixClass(): void
    {
        Assert::equalsWithoutLE(
            ...
            HTML,
            Select::widget()->items([1 => 'Moscu'])->suffix('value')->suffixClass('value')->suffixTag()->render()
        );
    }
