...
/**
 * Unit tests for {@see H5} `<h5>` behavior.
 *
 * Verifies rendered output, attribute handling, configuration precedence, and content encoding for {@see H5::tag()}.
 *
 * Test coverage.
 ...
 *
 * {@see H5} for implementation details.
 *
