...
/**
 * Unit tests for {@see H3} `<h3>` behavior.
 *
 * Verifies rendered output, attribute handling, configuration precedence, and content encoding for {@see H3::tag()}.
 *
 * Test coverage.
 ...
 *
 * {@see H3} for implementation details.
 *
