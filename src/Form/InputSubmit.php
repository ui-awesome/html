 ...
 * ```
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input/submit
 */
final class InputSubmit extends BaseInput implements ValueInterface
{
    use CanBeAutofocus;
    use HasTabindex;
    use HasValue;
