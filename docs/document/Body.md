...
Refer to the [Attribute Tests](https://github.com/ui-awesome/html/blob/main/tests/Document/Body/AttributeTest.php) for
...
Refer to the [Custom Methods Tests](https://github.com/ui-awesome/html/blob/main/tests/Document/Body/CustomMethodTest.php)
