...
Refer to the [Attribute Tests](https://github.com/ui-awesome/html/blob/main/tests/FormControl/Input/Color/AttributeTest.php)
...
Refer to the [Custom Methods Tests](https://github.com/ui-awesome/html/blob/main/tests/FormControl/Input/Color/CustomMethodTest.php)
for comprehensive examples.
...
Refer to the [Validate Tests](https://github.com/ui-awesome/html/blob/main/tests/FormControl/Input/Color/ValidateTest.php)
for comprehensive examples.
