...
Refer to the [Attribute Tests](https://github.com/ui-awesome/html/blob/main/tests/FormControl/Input/Button/AttributeTest.php)
...
Refer to the [Custom Methods Tests](https://github.com/ui-awesome/html/blob/main/tests/FormControl/Input/Button/CustomMethodTest.php) 
for comprehensive examples.
...
Refer to the [Label Tests](https://github.com/ui-awesome/html/blob/main/tests/FormControl/Input/Button/LabelTest.php) for
