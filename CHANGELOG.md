...
- Enh #40: Refactor tests to use `assertSame()` for rendering with `testRenderWithGlobalDefaultsAreApplied()` and `testRenderWithGlobalDefaultsAreApplied()` (@terabytesoftw)
